    ...
    <Link to={`/articles/${article.article_id}`}>
      <div
        ...
        <div className="flex flex-col justify-start items-start w-[70%] tablet:w-[76%] h-full pr-5 ">
          <div className=" text-[0.6rem] tablet-portrait:text-[0.95rem] tablet:text-[0.7rem] desktop:text-[0.675rem] xl-screen:text-[0.8rem] mt-1 tablet:mt-2 font-bold  dark:text-darkTextPrimary">
            {title}
          </div>
          <div className="text-[0.6rem] tablet-portrait:text-[0.8rem] tablet:text-[0.7rem] desktop:text-[0.675rem] xl-screen:text-[0.75rem] mt-2 mb-2 dark:text-darkTextPrimary text-textPrimary font-light ">
            {reducedBody}...
          </div>
        </div>
        <img
