  ...
  return (
    <Link to={`/articles/${article_id}`}>
      <div className="w-full border-b border-gray-200 p-3 cursor-pointer">
        ...
        <h3 className=" font-bold text-[0.85rem] sm:text-[0.9rem] text-gray-950 mt-3 sm:mt-0 sm:ml-[62px] sm:pb-1">
          {title}
        </h3>
        <img
          src={article_img_url}
          alt=""
          className="w-full h-[200px] sm:w-[90%] sm:h-[330px] pr-1 sm:mr-0 mt-1 mb-1 sm:ml-auto rounded-xl cursor-pointer"
        />
      </div>
    </Link>
  );
