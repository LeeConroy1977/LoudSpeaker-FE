...
const MainArticlesCard = ({ article, users, comment_count = 123 }) => {
  ...
  return (
    <div className="w-full border-b border-gray-200 p-3">
      <div className="flex items-center mt-1 ml-1">
        ...
        <p className="text-[10px] text-primary font-bold ml-3">{userDetail}</p>
      ...
      <img
        src={article_img_url}
        alt=""
        className="w-full h-[200px] sm:w-[90%] sm:h-[330px] mt-1 mb-1 sm:ml-auto rounded-xl"
      />
    </div>
  );
};
