...
const FeaturedList = ({ handleSelectedArticle }) => {
  const {
    state: { featuredArticles, loading, error },
  ...
  return (
    <div className="h-[100px] w-[580px] sm:h-full sm:w-full flex flex-row  sm:flex-col  m-2 mt-1 mb-2 ml-3 sm:ml-1 sm:mr-0 gap-2 sm:gap-3 p-3 ">
